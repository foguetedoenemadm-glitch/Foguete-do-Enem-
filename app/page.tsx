    ...
    <section id="home" className="relative py-20 md:py-40 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-8">
                <h1 className="text-5xl md:text-7xl font-extrabold font-headline leading-tight">
  ...
  return (
    <section id="social-proof" className="py-24 bg-card">
        <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-headline font-bold mb-4">Milhares de Alunos Já Decolaram Rumo à Aprovação</h2>
...
const BenefitsSection: FC = () => {
  return (
    <section id="benefits" className="py-24">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-headline font-bold mb-4">Por que o Foguete do <span className="text-primary">ENEM</span> é a sua melhor escolha?</h2>
        <p className="max-w-2xl mx-auto text-muted-foreground mb-16">
...
const TargetAudienceSection: FC = () => {
  return (
    <section id="target-audience" className="py-24 bg-card">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-headline font-bold mb-16">Para Quem é o Foguete do <span className="text-primary">ENEM</span>?</h2>
        <div className="grid md:grid-cols-3 gap-8">
    ...
    <section id="content-preview" className="py-24">
        <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-headline font-bold mb-6">O que você vai encontrar no material?</h2>
...
const ComparisonSection: FC = () => {
  return (
    <section id="comparison" className="py-24 bg-card">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-headline font-bold mb-4">Chega de se sentir perdido!</h2>
...
const CtaSection: FC = () => {
  return (
    <section id="cta" className="py-24 bg-gradient-to-t from-card">
        <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-5xl font-headline font-extrabold mb-6">Pronto para Lançar seu Futuro?</h2>
